...
func TestHumanDate(t *testing.T) {
	...
	// // If it isn't what we expect, use the t.Errorf() function to indicate that the test has failed and log the expected and actual values.
	...
	for _, tt := range tests {
		...
		// and the second parameter is and anonymous function containing the actual test for each case.
